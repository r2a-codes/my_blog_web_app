    ...
    <div className="user_profile_container">
      <div className="user_profile_wrapper">
        <div className="img_wrapper">
          {userData?.cover ? 
          <img src={userData?.cover} alt="user_cover" className="user_cover" /> :
           <FaImage className="user_cover"/>}
          

          {userData?.profile ? 
          <img src={userData.profile} alt="user_profile" className="user_profile" /> 
          : <FaUser className="user_profile ic"/>}
        </div>
      ...
      element == "saved_blogs" && me == userData?._id  ?
        ...
        <div className="user_blogs_wrapper">
         { followersData.length > 0 && followersData.map(fol => (
            <Follower key={fol._id} data={fol}setElement = {setElement}/>
         ))}
        </div> : ""
      }
    </div>}
